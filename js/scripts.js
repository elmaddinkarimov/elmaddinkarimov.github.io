...
var settings = {
	...
	bodyBackgroundImagePath: 'img/background-3.jpg', // path to the background image
	twitterWidgetId: '369843534712422402' // your Twitter widget ID (see the documentation)
}
